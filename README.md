...
> **Computational Engineer focused on CFD, HPC, and scientific computing**
...
- **work in progress:** the multi-language lid-driven cavity comparison
- **completed projects:** the individual MATLAB, C++, LBM, TSP, Rust, and JuPedSim studies

This matches the status used in the GitHub profile and repository READMEs.
...
- easy to host
- easy to review
- accessible without a build system
...
1. update its repository README
...
- ORCID: `0009-0007-2724-4565`

## Author

Ahmed Kandil — [LinkedIn](https://www.linkedin.com/in/ahmed-kandil03/) · [GitHub](https://github.com/Kandil2001) · [ORCID](https://orcid.org/0009-0007-2724-4565)
